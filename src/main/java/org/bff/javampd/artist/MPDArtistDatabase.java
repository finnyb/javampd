...
/**
 * MPDArtistDatabase represents a artist database controller to a {@link
 * org.bff.javampd.server.MPD}. To obtain an instance of the class you must use the {@link
 * org.bff.javampd.database.MusicDatabase#getArtistDatabase} method from the {@link
