 ...
 * a component using the component's <CODE>addPlayerChangeListener</CODE> method. When the player
 * event occurs, that object's <CODE>playerChanged</CODE> method is invoked.
 *
 * @author Bill
 * @version 1.0
 */
