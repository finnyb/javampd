...
/**
 * represents the server's statistics at the time it is called. The status has a default expiry
 * interval of 60 seconds. This can be overridden by using {@link #setExpiryInterval(long)}. You can
 * also force an update from the server by calling {@link #forceUpdate()}
 *
 * @author bill
 */
