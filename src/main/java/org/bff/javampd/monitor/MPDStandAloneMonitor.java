...
public class MPDStandAloneMonitor
  ...
  private void createMonitors() {
    standAloneMonitorThread.addMonitor(
      ...
      new ThreadedMonitor(
        playlistMonitor,
        monitorProperties.getPlaylistDelay()
      ),
      new ThreadedMonitor(
        connectionMonitor,
   ...
   */
  @Override
  public synchronized void addTrackPositionChangeListener(
    TrackPositionChangeListener tpcl
  ) {
   ...
   */
  @Override
  public synchronized void removeTrackPositionChangeListener(
    TrackPositionChangeListener tpcl
  ) {
  ...
  @Override
  public synchronized void addPlayerChangeListener(
    PlayerBasicChangeListener pcl
  ) {
  ...
  @Override
  public synchronized void removeVolumeChangeListener(
    VolumeChangeListener vcl
  ) {
  ...
  @Override
  public synchronized void removeBitrateChangeListener(
    BitrateChangeListener bcl
  ) {
  ...
  public synchronized void addPlaylistChangeListener(
    PlaylistBasicChangeListener pcl
  ) {
    playlistMonitor.addPlaylistChangeListener(pcl);
  }

  @Override
  public synchronized void removePlaylistChangeListener(
    PlaylistBasicChangeListener pcl
  ) {
