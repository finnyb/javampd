...
public interface Playlist {
  ...
  /**
   * Loads the songs in the given playlist to the current playlist. The playlist name can be givin
   * with or without the .m3u extension.
   *
  ...
  /**
   * Adds a {@link org.bff.javampd.song.MPDSong} to the playlist and fires a {@link
   * PlaylistChangeEvent} for event listeners
   *
  ...
  /**
   * Adds a {@link org.bff.javampd.album.MPDAlbum} by a {@link org.bff.javampd.artist.MPDArtist} to
   * the playlist.
   *
  ...
  /**
   * Removes a {@link org.bff.javampd.album.MPDAlbum} by a {@link org.bff.javampd.artist.MPDArtist}
   * from the playlist.
   *
  ...
  /**
   * Returns the list of songs in the playlist. This does query the MPD server for the list so care
   * should be taken not to call it excessively.
   *
