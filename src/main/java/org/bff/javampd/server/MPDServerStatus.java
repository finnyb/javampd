...
public class MPDServerStatus implements ServerStatus {
  ...
  @Inject
  public MPDServerStatus(
      ServerProperties serverProperties, CommandExecutor commandExecutor, Clock clock) {
  ...
  /**
   * Returns the current status of the requested status element. See {@link Status} for a list of
   * possible items returned by getStatus. If the status isn't part of the response "" is returned.
   *
