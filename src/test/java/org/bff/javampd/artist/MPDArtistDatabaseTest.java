...
public class MPDArtistDatabaseTest {
  ...
  public void testListArtistByName() {
    ...
    when(tagLister.list(TagLister.ListType.ARTIST, mockReturnName))
      .thenReturn(mockReturnArtist);
