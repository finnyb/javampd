...
public class MPDTagListerTest {
  ...
  public void testListInfoDouble() {
    ...
    List<String> infoList = new ArrayList<>(
      tagLister.listInfo(
        TagLister.ListInfoType.PLAYLIST,
  ...
  public void testListGroupArtist() {
    ...
    when(commandExecutor.sendCommand("list", "album", "group", "artist"))
      .thenReturn(retList);
    when(databaseProperties.getList()).thenReturn("list");
    when(databaseProperties.getGroup()).thenReturn("group");
    List<String> infoList = new ArrayList<>(
      tagLister.list(TagLister.ListType.ALBUM, TagLister.GroupType.ARTIST)
    );
  ...
  public void testListGroupDate() {
    ...
    when(commandExecutor.sendCommand("list", "album", "group", "date"))
      .thenReturn(retList);
    when(databaseProperties.getList()).thenReturn("list");
    when(databaseProperties.getGroup()).thenReturn("group");

    List<String> infoList = new ArrayList<>(
      tagLister.list(TagLister.ListType.ALBUM, TagLister.GroupType.DATE)
    );
  ...
  public void testListGroupGenre() {
    ...
    when(commandExecutor.sendCommand("list", "album", "group", "genre"))
      .thenReturn(retList);
    when(databaseProperties.getList()).thenReturn("list");
    when(databaseProperties.getGroup()).thenReturn("group");

    List<String> infoList = new ArrayList<>(
      tagLister.list(TagLister.ListType.ALBUM, TagLister.GroupType.GENRE)
    );
  ...
  public void testListError() {
    ...
    List<String> infoList = new ArrayList<>(
      tagLister.list(TagLister.ListType.ARTIST)
    );
  ...
  public void testListWithParam() {
    ...
    when(commandExecutor.sendCommand("list", "album", "artist"))
      .thenReturn(retList);
    when(databaseProperties.getList()).thenReturn("list");

    List<String> infoList = new ArrayList<>(
      tagLister.list(TagLister.ListType.ALBUM, params)
    );
