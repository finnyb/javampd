...
class MPDSongConverterTest {
    ...
    @Test
    void defaults() {
        var s = converter.convertResponseToSongs(List.of("file: Tool/10,000 Days/01 Vicarious.flac")).get(0);
        assertAll(
    ...
    void terminationNull() {
        assertEquals("Tool/10,000 Days/01 Vicarious.flac",
                converter.convertResponseToSongs(List.of("file: Tool/10,000 Days/01 Vicarious.flac"))
                        .get(0)
                        .getFile());
    }
    ...
    void clearAttributes() {
        var songs = converter.convertResponseToSongs(
                Arrays.asList(
                        ...
                        "Date: 2006",
                        "Track: 1",
                        "file: Greta Van Fleet/Anthem of the Peaceful Army/03-When the Curtain Falls.flac",
    ...
    void multipleLast() {
        ...
        assertAll(
                ...
                () -> assertEquals("Greta Van Fleet/Anthem of the Peaceful Army/02 The Cold Wind.flac", s3.getFile())
        );
    }

    @Test
    void fileNameList() {
        var files = this.converter.getSongFileNameList(Arrays.asList(
                "file: Tool/10,000 Days/01 Vicarious.flac",
        ...
        assertAll(
                ...
                () -> assertEquals("Greta Van Fleet/Anthem of the Peaceful Army/02 The Cold Wind.flac", files.get(1))
        );
    }
