...
class MPDServerStatusTest {
  ...
  void testPlaylistSongNumber() {
    ...
    serverStatus
        .playlistSongNumber()
        .ifPresentOrElse(s -> assertThat(s, is(id)), () -> fail("song was empty"));
  }
  ...
  void testPlaylistSongId() {
    ...
    serverStatus
        .playlistSongId()
        .ifPresentOrElse(s -> assertThat(s, is(id)), () -> fail("id was empty"));
  }
  ...
  void testPlaylistNextSongNumber() {
    ...
    serverStatus
        .playlistNextSongNumber()
        .ifPresentOrElse(s -> assertThat(s, is(id)), () -> fail("number was empty"));
  }
  ...
  void testDurationCurrentSong() {
    ...
    serverStatus
        .durationCurrentSong()
        .ifPresentOrElse(s -> assertThat(s, is(duration)), () -> fail("duration was empty"));
  }
  ...
  void testMixRampDb(int db) {
    ...
    serverStatus
        .getMixRampDb()
        .ifPresentOrElse(s -> assertThat(s, is(db)), () -> fail("db was empty"));
  }
  ...
  void testMixRampDelay(int delay) {
    ...
    serverStatus
        .getMixRampDelay()
        .ifPresentOrElse(s -> assertThat(s, is(delay)), () -> fail("delay was empty"));
  }
