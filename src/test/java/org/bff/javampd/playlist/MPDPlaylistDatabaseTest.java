...
public class MPDPlaylistDatabaseTest {
  ...
  public void testListSavedPlaylists() {
    ...
    MPDSavedPlaylist mockedSavedPlaylist1 = new MPDSavedPlaylist(
      testPlaylistName1
    );
    mockList.add(mockedSavedPlaylist1);
    MPDSavedPlaylist mockedSavedPlaylist2 = new MPDSavedPlaylist(
      testPlaylistName2
    );
    ...
    List<MPDSavedPlaylist> playlists = new ArrayList<>(
      playlistDatabase.listSavedPlaylists()
    );
  ...
  public void testListSavedPlaylistsSongs() {
    ...
    when(songConverter.getSongFileNameList(mockedResponseList))
      .thenReturn(mockedResponseList);

    when(songDatabase.searchFileName(testPlaylistName1))
      .thenReturn(mockedSongs1);
    when(songDatabase.searchFileName(testPlaylistName2))
      .thenReturn(mockedSongs2);
