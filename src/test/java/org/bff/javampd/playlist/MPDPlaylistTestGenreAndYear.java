...
class MPDPlaylistTestGenreAndYear {
  ...
  void testRemoveGenre() {
    ...
    MPDPlaylistSong song3 =
        MPDPlaylistSong.builder().file("file3").title("testSong1").genre("bogus").build();
  ...
  void testRemoveGenreByName() {
    ...
    var mockedSongs = new ArrayList<MPDPlaylistSong>();
    MPDPlaylistSong song1 =
        MPDPlaylistSong.builder().file("file1").title("testSong1").genre(genre).id(1).build();

    MPDPlaylistSong song2 =
        MPDPlaylistSong.builder().file("file2").title("testSong1").genre(genre).id(2).build();
  ...
  void testRemoveYear() {
    ...
    var mockedSongs = new ArrayList<MPDPlaylistSong>();
    MPDPlaylistSong song1 =
        MPDPlaylistSong.builder().file("file1").title("testSong1").date(year).id(1).build();

    MPDPlaylistSong song2 =
        MPDPlaylistSong.builder().file("file2").title("testSong1").date(year).id(2).build();

    MPDPlaylistSong song3 =
        MPDPlaylistSong.builder().file("file3").title("testSong1").date("bogus").build();
