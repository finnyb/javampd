...
public class MPDPlaylistTestSong {
  ...
  @Test
  public void testAddSongNoEvent() {
    when(serverStatus.getPlaylistVersion()).thenReturn(-1);
  ...
  @Test
  public void testAddSongFileNoEvent() {
    when(serverStatus.getPlaylistVersion()).thenReturn(-1);
  ...
  public void testAddSongs() {
    ...
    assertEquals(
      "test1",
      commandArgumentCaptor.getAllValues().get(0).get(0).getParams().get(0)
    );
    assertEquals(
      realPlaylistProperties.getAdd(),
    ...
    assertEquals(
      "test2",
      commandArgumentCaptor.getAllValues().get(0).get(1).getParams().get(0)
    );
    assertEquals(
  ...
  @Test
  public void testAddSongsNoEvent() {
    when(serverStatus.getPlaylistVersion()).thenReturn(-1);
  ...
  public void testRemoveSong() {
    ...
    assertEquals(
      realPlaylistProperties.getRemove(),
  ...
  @Test
  public void testRemoveSongByPosition() {
    when(serverStatus.getPlaylistVersion()).thenReturn(1);
  ...
  @Test
  public void testRemoveSongByBadPosition() {
    int position = -1;
