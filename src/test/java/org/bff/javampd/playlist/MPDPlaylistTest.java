...
public class MPDPlaylistTest {
  ...
  public void testFirePlaylistChangeEventSongAdded() {
    ...
    playlist.firePlaylistChangeEvent(
      PlaylistChangeEvent.Event.SONG_ADDED,
      "name"
    );
  ...
  public void testClearPlaylist() {
    ...
    assertEquals(
      realPlaylistProperties.getClear(),
      stringArgumentCaptor.getAllValues().get(0)
    );
    assertEquals(
      PlaylistChangeEvent.Event.PLAYLIST_CLEARED,
      changeEvent[0].getEvent()
    );
  }
  ...
  public void testDeletePlaylist() {
    ...
    assertEquals(
      realPlaylistProperties.getDelete(),
      stringArgumentCaptor.getAllValues().get(0)
    );
    assertEquals("testPlaylist", stringArgumentCaptor.getAllValues().get(1));
    assertEquals(
      PlaylistChangeEvent.Event.PLAYLIST_DELETED,
      changeEvent[0].getEvent()
    );
  }
  ...
  public void testMoveById() {
    ...
    assertEquals(
      realPlaylistProperties.getMoveId(),
  ...
  public void testMoveByPosition() {
    ...
    assertEquals(
      realPlaylistProperties.getMove(),
      stringArgumentCaptor.getValue()
    );
    assertEquals((Integer) 3, integerArgumentCaptor.getAllValues().get(0));
    assertEquals((Integer) 5, integerArgumentCaptor.getAllValues().get(1));
  ...
  public void testShuffle() {
    ...
    assertEquals(
      realPlaylistProperties.getShuffle(),
      stringArgumentCaptor.getValue()
    );
    assertEquals(
      PlaylistChangeEvent.Event.PLAYLIST_CHANGED,
  ...
  public void testSwapByExplicitId() {
    ...
    assertEquals(
      realPlaylistProperties.getSwapId(),
      stringArgumentCaptor.getValue()
    );
    assertEquals((Integer) 3, integerArgumentCaptor.getAllValues().get(0));
    assertEquals((Integer) 5, integerArgumentCaptor.getAllValues().get(1));
  ...
  public void testSwapByPosition() {
    ...
    assertEquals(
      realPlaylistProperties.getSwap(),
      stringArgumentCaptor.getValue()
    );
    assertEquals((Integer) 3, integerArgumentCaptor.getAllValues().get(0));
    assertEquals((Integer) 5, integerArgumentCaptor.getAllValues().get(1));
  ...
  public void testPlaylistSave() {
    ...
    assertTrue(saved);
    assertEquals(
      realPlaylistProperties.getSave(),
      stringArgumentCaptor.getAllValues().get(0)
    );
    assertEquals("name", stringArgumentCaptor.getAllValues().get(1));
    assertEquals(
      PlaylistChangeEvent.Event.PLAYLIST_SAVED,
      changeEvent[0].getEvent()
    );
  }
