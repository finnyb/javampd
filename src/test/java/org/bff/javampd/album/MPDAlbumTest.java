...
class MPDAlbumTest {
    ...
    void defaultArtistList() {
        ...
        assertThat(artist,
                is(equalTo(album.getArtistNames().get(0))));
    }
    ...
    void addGenre() {
        ...
        album.addGenre("Rock");
        assertThat("Rock",
                is(equalTo(album.getGenres().get(0))));
    }
    ...
    void addDate() {
        ...
        album.addDate("1990");
        assertThat("1990",
                is(equalTo(album.getDates().get(0))));
    }
    ...
    void testCompareToLessThanZero() {
        MPDAlbum album1 = MPDAlbum.builder("Album1")
                .artistNames(Collections.singletonList("artistName1"))
                .build();

        MPDAlbum album2 = MPDAlbum.builder("Album2")
                .artistNames(Collections.singletonList("artistName1"))
                .build();
    ...
    void testCompareToGreaterThanZero() {
        MPDAlbum album1 = MPDAlbum.builder("Album2")
                .artistNames(Collections.singletonList("artistName1"))
                .build();

        MPDAlbum album2 = MPDAlbum.builder("Album1")
                .artistNames(Collections.singletonList("artistName1"))
                .build();
